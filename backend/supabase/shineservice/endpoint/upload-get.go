...
func ShineHandler(shineSvc *SupabaseShines.Service) http.HandlerFunc {
...
func handlePostShine(w http.ResponseWriter, r *http.Request, uid string, ShineSvc *SupabaseShines.Service) {
